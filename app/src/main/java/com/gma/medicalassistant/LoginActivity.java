...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private static final String[] DUMMY_CREDENTIALS = new String[]{
            "P0104:18621373333", "test1:13012341234"
    };
    /**
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            mAuthTask = new UserLoginTask(userId, phoneNum);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        UserLoginTask(String userId, String phoneNum) {
            mUserId = userId;
            mPhoneNum = phoneNum;
        }
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            for (String credential : DUMMY_CREDENTIALS) {
                ...
                if (pieces[0].equals(mUserId)) {
                    ...
                    return pieces[1].equals(mPhoneNum);
                }
            }
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                mPhoneNumView.setError(getString(R.string.error_incorrect_phone_number));
